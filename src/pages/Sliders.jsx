...
// ═══════════════════════════════════════════════════════════════
// SLIDERS MANAGEMENT — with ImageInput
// ═══════════════════════════════════════════════════════════════
      ...
      <DialogContent dividers sx={{ p: 3, borderColor: T.border }}>
        <Stack spacing={2.5}>
          ...
          <ImageInput
            ...
            folder="local-guider/sliders"
            required
            aspect="wide"
            helperText="Recommended: 1200x600px, JPG/PNG, under 10MB"
          />
  ...
  const columns = [
    {
      ...
      renderCell: (params) => (
        <Box
          component="img"
          src={getImageUrlGeneric(params.row.image, "Slider")}
          alt="slider"
          sx={{
            width: 72,
            height: 40,
      ...
      >
        ...
        <Box sx={{ px: 3, py: 2 }}>
          <Typography sx={{ fontSize: "0.85rem", color: T.textMuted }}>
            This will permanently delete the slider. This action cannot be
            undone.
          </Typography>
        </Box>
