...
import {
  FaArrowLeft, FaFilePdf, FaEnvelope, FaPhone,
  FaBriefcase, FaMapMarkerAlt, FaCamera, FaBuilding,
} from 'react-icons/fa';
import {
...
const DocThumb = ({ src, label, onClick }) => (
  ...
  >
    ...
    >
      <Typography sx={{ fontSize: '0.65rem', fontWeight: 700, color: '#fff', textAlign: 'center' }}>
        {label}
      </Typography>
    </Box>
  </Box>
  ...
  return (
    <Box sx={{ p: { xs: 2, md: 3 }, maxWidth: 1100, mx: 'auto' }}>
        ...
        >
          ...
          <Button
            ...
            sx={{
              ...
              '&.Mui-disabled': { bgcolor: T.rose, opacity: 0.6, color: '#fff' },
            }}
          >
      ...
      {(photographer.about || photographer.bio) && (
        ...
        >
          <SectionHeader title="About" subtitle="Profile summary" accent={T.rose} />
          <Typography
            sx={{
              fontSize: '0.85rem',
              color: T.textPrimary,
      ...
      <Box sx={{ position: 'absolute', left: -9999, top: 0 }}>
        <Box ref={downloadRef}>
          ...
          >
            <Box sx={{ textAlign: 'center', borderBottom: '4px solid #f43f5e', pb: 2.5, mb: 2.5 }}>
              <Typography sx={{ color: '#f43f5e', fontSize: '32px', m: 0, fontWeight: 700 }}>
                Local Guider
              </Typography>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2.5, pb: 2.5, borderBottom: '2px solid #eee' }}>
              ...
              <Box>
                ...
                <Typography sx={{ fontSize: '14px', my: 0.5 }}>
                  <strong>Location:</strong> {photographer.location || photographer.city || 'N/A'}
                </Typography>
                <Typography sx={{ fontSize: '14px', my: 0.5 }}>
                  <strong>Status:</strong> {photographer.isActive ? 'Active' : 'Inactive'}
                </Typography>
              </Box>
            </Box>

            <Box sx={{ mb: 2.5 }}>
              <Typography sx={{ color: '#f43f5e', borderBottom: '2px solid #f43f5e', pb: 0.5, fontSize: '20px', fontWeight: 700 }}>
                Contact Information
              </Typography>
            ...
            <Box sx={{ mb: 2.5 }}>
              ...
              <Typography sx={{ fontSize: '14px', my: 1 }}>
                <strong>Experience:</strong> {photographer.experience || 0} years
              </Typography>
              <Typography sx={{ fontSize: '14px', my: 1 }}>
                <strong>Rating:</strong> {photographer.rating || 0}
              </Typography>
              <Typography sx={{ fontSize: '14px', my: 1 }}>
                <strong>Camera:</strong> {photographer.cameraDetails || 'N/A'}
              </Typography>
            </Box>
            ...
            <Box sx={{ mb: 2.5 }}>
              ...
              <Typography sx={{ fontSize: '14px', lineHeight: 1.6 }}>
                {photographer.about || photographer.bio || 'No bio provided'}
              </Typography>
            </Box>

            <Box sx={{ textAlign: 'center', borderTop: '2px solid #f43f5e', pt: 1.5, mt: 2.5 }}>
