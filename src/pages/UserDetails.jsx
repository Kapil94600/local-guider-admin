...
import {
  Box, Paper, Typography, Avatar, Chip, Grid, Divider, Stack,
...
// ✅ SAME utility jo Users.jsx me use ho rahi hai
...
const UserDetails = () => {
  ...
  // ✅ Same utility use karo — image aur fallback dono consistent
      ...
      >
        ...
        >
          ...
          <Box sx={{ flex: 1 }}>
            <Typography
              variant="h4"
              sx={{ fontFamily: FONT_DISPLAY, fontWeight: 700, color: 'text.primary' }}
            >
              {fullName}
            </Typography>
            ...
            <Stack direction="row" spacing={1} sx={{ mt: 2, flexWrap: 'wrap', gap: 1 }}>
              ...
              <Chip
                label={selectedItem.accountStatus || 'ACTIVE'}
                size="small"
                variant="outlined"
              />
          ...
          <DetailItem
            ...
            value={
              selectedItem.emailVerifiedAt
                ? new Date(selectedItem.emailVerifiedAt).toLocaleDateString()
                : 'No'
            }
          />
        </Grid>
          ...
          <DetailItem
            ...
            value={
              selectedItem.lastLoginAt
                ? new Date(selectedItem.lastLoginAt).toLocaleString()
                : 'N/A'
            }
          />
        </Grid>
