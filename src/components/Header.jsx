...
import {
  IconButton, Badge, ClickAwayListener, Fade, Box, Typography,
  Avatar, Stack, Chip, useMediaQuery, useTheme, Divider,
} from '@mui/material';
import {
  Menu as MenuIcon,
  ...
  KeyboardCommandKeyOutlined as CommandIcon,
    ...
    >
      ...
      <Box
        sx={{
          ...
          flex: 1, maxWidth: 460, mx: 3,
        }}
      >
        <Box
          sx={{
            display: 'flex', alignItems: 'center', width: '100%',
            bgcolor: '#f8fafc', borderRadius: 999, px: 2, py: 0.85,
            border: '1px solid #e8ecf3', transition: 'all 0.2s ease',
            cursor: 'text',
            '&:focus-within': {
              bgcolor: '#ffffff',
              borderColor: '#a5b4fc',
        ...
        >
          ...
          <input
            ...
            style={{
              ...
              fontSize: '0.85rem', width: '100%', color: '#475569',
              fontFamily: 'inherit',
            }}
          />
          {!isMobile && (
            <Box
              sx={{
                ...
                bgcolor: '#fff', border: '1px solid #e8ecf3',
                flexShrink: 0, ml: 1,
              }}
            >
              <CommandIcon sx={{ fontSize: 12, color: '#94a3b8' }} />
          ...
          <Box sx={{ position: 'relative' }} ref={notifRef}>
            <IconButton
              ...
              sx={{
                ...
                '&:hover': { bgcolor: '#eef2f9', borderColor: '#c7d2fe' },
              }}
            >
              <Badge
              ...
              >
                ...
                <Box sx={{ maxHeight: 360, overflowY: 'auto' }}>
                  {loading && notifications.length === 0 ? (
                    ...
                    <Box sx={{ px: 2, py: 6, textAlign: 'center', color: '#94a3b8' }}>
                      ...
                      return (
                        <Box
                          ...
                          sx={{
                            ...
                            position: 'relative',
                            bgcolor: !n.isRead ? 'rgba(238,242,255,0.5)' : 'transparent',
                        ...
                        >
                          ...
                          <Stack direction="row" spacing={1.5} alignItems="flex-start">
                            <Box
                              sx={{
                                flexShrink: 0, px: 1, py: 0.4,
                                borderRadius: 1, bgcolor: colors.bg, color: colors.color,
                                fontSize: '0.6rem', fontWeight: 700,
                                letterSpacing: '0.03em', mt: 0.2,
                              }}
                            >
                            ...
                            <Box sx={{ minWidth: 0, flex: 1 }}>
                              <Typography
                                sx={{
                                  ...
                                  color: '#1e293b', lineHeight: 1.3, mb: 0.3,
                                }}
                                noWrap
                              >
                ...
                <Box
                  sx={{
                    px: 2, py: 1.25, borderTop: '1px solid #f1f5f9',
                    textAlign: 'center', bgcolor: '#fafbfd',
                  }}
                >
                  <button
                    ...
                    style={{
                      ...
                      fontSize: '0.75rem', color: '#4f46e5', fontWeight: 700,
          ...
          <Box sx={{ position: 'relative' }} ref={userMenuRef}>
            ...
            <Fade in={userMenuOpen} timeout={200}>
              <Box
                sx={{
                  position: 'absolute', right: 0, top: 'calc(100% + 10px)',
                  width: 240, bgcolor: '#ffffff', borderRadius: 3,
                  border: '1px solid #e8ecf3',
                  boxShadow:
                    '0 20px 40px -12px rgba(15,23,42,0.15), 0 8px 16px -8px rgba(15,23,42,0.08)',
                  overflow: 'hidden', zIndex: 1300,
              ...
              >
                ...
                <Box sx={{ p: 1 }}>
                  {[
                    { icon: <PersonIcon sx={{ fontSize: 18 }} />, label: 'My Profile', path: '/profile' },
                    { icon: <SettingsIcon sx={{ fontSize: 18 }} />, label: 'Settings', path: '/settings' },
                  ].map((item) => (
                    <Box
                      key={item.label}
